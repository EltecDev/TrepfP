...
import com.example123.trepfp.FragmentLogger
            ...
            do {
                ...
                if (isConnected) {
                    ...
                    if (!llave.equals("empty")) {
                        ...
                        var T33CB2 = bluetoothLeService!!.listData.joinToString("").replace(" ", "")
                        ...
                        esp!!.putString("T33CB1", T33CB2.toString())
                        esp!!.putString("CElTime1", CElTime2.toString())
                        esp!!.apply()
                        BanderaLLave = true
 ...
 */
  ...
  */
    ...
    private fun checkGooglePlayServicesGEO(callback: (latitude: Float, longitude: Float) -> Unit) {
